# Script to create the training data for the transition state classifier.
# Need to run data_processing.py first to create the energies_coordinates.csv file containing the coordinates of each molecule and its corresponding energy.
...
#read our data
sample_df = pd.read_csv('/Users/Andrew/Documents/Edinburgh/ChemistyML/energies_coordinates.csv')
