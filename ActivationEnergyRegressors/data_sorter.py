# Script to extract all the reactions.
# It creates a list of the paths to each of combination of reactants and products, with the corresponding transition state energy for the pair.
